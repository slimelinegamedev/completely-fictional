System.register("src/js/head/app.ctrl.js", [], function (_export) {
	"use strict";
...
System.register('src/js/head/app.router.js', [], function (_export) {
	'use strict';
...
System.register('src/js/head/app.js', ['github:angular/bower-angular@1.4.7', 'github:angular-ui/ui-router@0.2.15', 'src/js/head/app.router.js', 'src/js/head/app.ctrl.js'], function (_export) {
	'use strict';
	...
	return {
		...
		}, function (_githubAngularUiUiRouter0215) {}, function (_srcJsHeadAppRouterJs) {
			router = _srcJsHeadAppRouterJs['default'];
		}, function (_srcJsHeadAppCtrlJs) {
