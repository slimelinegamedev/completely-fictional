export default {
  template: `
    ...
    <div class="content">
      ...
      <ul class="padding">
        <li>I wrote a short story based on Kimbra lyrics and I called it, uh, <a class="extras">Kimbra</a>.</li>
        ...
        <li>This is an <a class="extras">image list of cool places I like</a> inspired by John Campbell's old image list of webcomics he liked.</li>
